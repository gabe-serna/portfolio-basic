            ...
            <DialogContent className="flex flex-col lg:flex-row">
              <DialogHeader className="text-left">
                ...
                <DialogDescription className="mr-4 sm:w-[40ch]">
                  ...
                  transcribing music.
                  <br /> <br />
                  Songscribe is a web app that uses machine learning algorithms
                  to instantly generate sheet music for any song. Refine the
                  MIDI transcription with several adjustable parameters, and
                  export the final score for further adjustment.
                </DialogDescription>
              </DialogHeader>
            ...
            <DialogContent className="flex flex-col lg:flex-row">
              <DialogHeader className="text-left">
                ...
                <DialogDescription className="mr-4 sm:w-[40ch]">
                  ...
                  .
                  <br /> <br />
                  Where to Live is a web app currently under development that
                  will visualize the best places to live in the world based on
